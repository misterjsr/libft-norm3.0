...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/13 18:30:16 by jeserran          #+#    #+#             */
/*   Updated: 2021/05/13 19:20:44 by jeserran         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_lstadd_front(t_list **alst, t_list *next);
int				ft_lstsize(t_list *lst);
t_list			*ft_lstlast(t_list *lst);
void			ft_lstadd_back(t_list **alst, t_list *next);
